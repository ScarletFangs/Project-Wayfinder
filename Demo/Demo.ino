 ...
 * means of navigation. Collision response functions have been included for use with both RCDrive() and GPSNavigation().
 * ObstacleAvoidance() is not currently used. Also includes telemetry through the means of a bluetooth module 
 * communicating with a cellphone/laptop.
...
void setup() {
  ...
  Serial.println("Begin Compass Calibration. Activate Rear & Front Right Limit Switches to Exit Calibration.");
